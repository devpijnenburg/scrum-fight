...
const BADGE_GROUPS = [
  ...
  },
  {
    id: 'coffee_question',
    icon: '☕',
    title: { nl: 'Koffie & Vraagteken', en: 'Coffee & Question mark' },
    badges: [
      { id: 'coffee_break', tier: 'bronze', icon: '☕', ...atLeast((d) => voteCount(d, ['☕']), 1),
        name: { nl: 'Koffiepauze', en: 'Coffee Break' }, desc: { nl: 'Je eerste koffiekaart. Soms is pauze het antwoord.', en: 'Your first coffee card. Sometimes a break is the answer.' } },
      { id: 'barista', tier: 'silver', icon: '🍵', ...atLeast((d) => voteCount(d, ['☕']), 15),
        name: { nl: 'Barista', en: 'Barista' }, desc: { nl: '15× voor koffie gekozen. Jij weet prioriteiten te stellen.', en: '15 times coffee. You know what matters.' } },
      { id: 'coffee_addict', tier: 'gold', icon: '☕', ...atLeast((d) => voteCount(d, ['☕']), 40),
        name: { nl: 'Koffiejunk', en: 'Coffee Addict' }, desc: { nl: '40× koffie. Zijn er eigenlijk nog estimates gedaan?', en: '40 times coffee. Did anyone actually estimate anything?' } },
      { id: 'espresso_yourself', tier: 'diamond', icon: '☕', ...atLeast((d) => voteCount(d, ['☕']), 75),
        name: { nl: 'Espresso Yourself', en: 'Espresso Yourself' }, desc: { nl: '75× koffie. Jij BENT de koffieautomaat. Pun intended.', en: '75 times coffee. You ARE the coffee machine. Pun intended.' } },
      { id: 'first_doubt', tier: 'bronze', icon: '❓', ...atLeast((d) => voteCount(d, ['?']), 3),
        name: { nl: 'Eerste Twijfel', en: 'First Doubt' }, desc: { nl: 'Je weet wanneer je het niet weet.', en: 'You know when you don\'t know.' } },
      { id: 'sceptic', tier: 'silver', icon: '🤔', ...atLeast((d) => voteCount(d, ['?']), 20),
        name: { nl: 'De Scepticus', en: 'The Sceptic' }, desc: { nl: '20× vraagteken. Altijd kritisch, nooit overtuigd.', en: '20 times ?. Always critical, never convinced.' } },
      { id: 'philosopher', tier: 'gold', icon: '🧐', ...atLeast((d) => voteCount(d, ['?']), 50),
        name: { nl: 'De Filosoof', en: 'The Philosopher' }, desc: { nl: '50× vraagteken. Descartes zou trots zijn.', en: '50 times ?. Descartes would be proud.' } },
      { id: 'oracle', tier: 'diamond', icon: '🔮', ...atLeast((d) => voteCount(d, ['?']), 100),
        name: { nl: 'De Orakel', en: 'The Oracle' }, desc: { nl: '100× vraagteken. Of jij weet alles — of helemaal niets.', en: '100 times ?. Either you know everything — or nothing at all.' } },
    ],
  },
  {
    id: 'spectator_reactions',
    icon: '👁',
    title: { nl: 'Spectator & Reacties', en: 'Spectator & Reactions' },
    badges: [
      { id: 'ghost', tier: 'bronze', icon: '👻', ...atLeast((d) => d.spectatorSessions || 0, 1),
        name: { nl: 'De Geest', en: 'The Ghost' }, desc: { nl: 'Je eerste keer toekijken. Aanwezig, maar onzichtbaar.', en: 'First time spectating. Present but invisible.' } },
      { id: 'phantom', tier: 'silver', icon: '👁', ...atLeast((d) => d.spectatorSessions || 0, 15),
        name: { nl: 'Het Fantoom', en: 'The Phantom' }, desc: { nl: '15× op de tribune. Het team merkt het niet, maar jij wel.', en: '15 times watching. The team doesn\'t notice — but you do.' } },
      { id: 'eternal_watcher', tier: 'gold', icon: '🔭', ...atLeast((d) => d.spectatorSessions || 0, 50),
        name: { nl: 'De Eeuwige Toeschouwer', en: 'The Eternal Watcher' }, desc: { nl: '50× gekeken. Je weet alles, zegt niets.', en: '50 times spectating. You know everything, say nothing.' } },
      { id: 'reactor', tier: 'bronze', icon: '🎉', ...atLeast((d) => d.totalReactions || 0, 10),
        name: { nl: 'Reaguurder', en: 'Reactor' }, desc: { nl: '10 emoji-reacties. Jij houdt het levendig.', en: '10 emoji reactions. You keep the energy alive.' } },
      { id: 'hype_machine', tier: 'silver', icon: '🔥', ...atLeast((d) => d.totalReactions || 0, 100),
        name: { nl: 'Hype Machine', en: 'Hype Machine' }, desc: { nl: '100 reacties. Het team heeft energie nodig — jij levert.', en: '100 reactions. The team needs energy — you deliver.' } },
      { id: 'emoji_god', tier: 'diamond', icon: '🌟', ...atLeast((d) => d.totalReactions || 0, 500),
        name: { nl: 'Emoji God', en: 'Emoji God' }, desc: { nl: '500 reacties. Communiceren met woorden is overgewaardeerd.', en: '500 reactions. Words are overrated.' } },
    ],
  },
  {
    id: 'estimation',
  ...
  },
  {
    ...
    badges: [
      ...
      { id: 'speed_estimator', tier: 'silver', icon: '20', ...atLeast((d) => d.maxDayRounds || 0, 10),
        name: { nl: 'Speed Estimator', en: 'Speed Estimator' }, desc: { nl: 'Voltooi 10 rondes op één dag.', en: 'Complete 10 rounds in a single day.' } },
      { id: 'lightning_round', tier: 'gold', icon: '⚡', ...atLeast((d) => d.maxDayRounds || 0, 20),
        name: { nl: 'Lightning Round', en: 'Lightning Round' }, desc: { nl: 'Voltooi 20 rondes op één dag.', en: 'Complete 20 rounds in a single day.' } },
  ...
  },
  {
    ...
    badges: [
      ...
      { id: 'contrarian', tier: 'silver', icon: '☻', ...atLeast((d) => voteCount(d, '?'), 10),
      ...
      { id: 'eight_ball', tier: 'silver', icon: '🎱', ...atLeast((d) => voteCount(d, ['8']), 20),
        name: { nl: 'Acht voor Alles', en: 'Eight Ball' }, desc: { nl: '20× gekozen voor de 8. Veilig, voorspelbaar, effectief.', en: '20 times you chose 8. Safe, predictable, effective.' } },
      { id: 'centurion', tier: 'gold', icon: '💯', ...atLeast((d) => voteCount(d, ['100']), 5),
        name: { nl: 'De Honderd', en: 'The Centurion' }, desc: { nl: '5× gestemd op 100. Jij ziet elk issue als een epic.', en: '5 times you voted 100. Every story is an epic.' } },
      { id: 'pessimist', tier: 'gold', icon: '📈', ...atLeast((d) => voteCount(d, ['89', '100', 'XXL']), 10),
        name: { nl: 'De Pessimist', en: 'The Pessimist' }, desc: { nl: '10× het hoogste gekozen. Complexiteit ziet jou ook aankomen.', en: '10 times the highest. Complexity knows your name.' } },
    ],
  },
  {
    id: 'ultra',
